...
window.styleStatusSelect = function(sel){
  ...
  function init() {    loadStorage();    renderProjectSelectOptions();    initTimeOptions();    bindEvents();    updateDetailPriorityResult();    bindChartTabs();    resetForm();    tickClock();    setInterval(tickClock, 1000);    renderAll();  }  init();})();
/* ============================================================
